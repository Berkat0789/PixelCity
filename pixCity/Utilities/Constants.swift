...
func FlickrAURL (annotation: DroppablePin, ApiKEy: String, NumberoFPhotos count: Int) -> String {
    return "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(ApiKEy)&lat=\(annotation.coordinate.latitude)&lon=\(annotation.coordinate.longitude)&radius=1&radius_units=mi&per_page=\(count)&format=json&nojsoncallback=1"
}
